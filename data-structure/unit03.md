...
<img src="https://raw.githubusercontent.com/Team-Gravit/gravit-images/main/data-structure/unit03/image.png" width="50%">
...
**양쪽 끝에서 삽입과 삭제가 모두 가능**한 자료구조다. **Front**와 **Rear** 모두에서 **O(1)** 시간에 **삽입**/**삭제** 연산을 수행할 수 있다. **스택과 큐의 기능을 모두 제공**하며, 배열 또는 연결리스트로 구현 가능하다.
